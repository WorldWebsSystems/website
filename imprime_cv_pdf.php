		...
		<table width='100%'>
			...
			<tr>
				...
				<td align='center'>
					...
					$resultado4 = mysqli_query($connect, "SELECT * FROM cv where id_red = $row33[id] order by tipo asc");
					...
					while ($row4 = mysqli_fetch_array($resultado4)) {
						...
						if ($tipo == $row4[tipo]) {
							...
							switch ($row4[tipo]) {
								...
								case 3:
									if ($cv3 == 1) {
										echo "<font size='3'><b>Congresos, Ponencias, Cursos, Seminarios y Talleres:</b></font>";
										echo "<b><br><hr></b>";
									}
									break;
								case 4:
									if ($cv4 == 1) {
										echo "<font size='3'><b>Portafolio de Proyectos y Productos:</b></font>";
										echo "<b><br><hr></b>";
									}
									break;
								case 5:
							...
							$resultado41 = mysqli_query($connect, "SELECT * FROM cv where id_red = $row33[id] and tipo = $tipo-1 order by actual desc, anohasta desc, meshasta desc, anodesde desc, mesdesde desc, titulo asc, descripcion asc");
										...
										<td>
											...
											if ($hasta <> '/0') {
												...
												if ($row41[tipo] == 2) {
													...
													$duracion = calcula_antiguedad($row41[anodesde] . '/' . $row41[mesdesde] . '/01' , $row41[anohasta] . '/' . $row41[meshasta] . '/01');
