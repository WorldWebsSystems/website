...
<html class="no-js" lang="es">
	...
	if ($row33[status] == 0) {
		...
		$titulo = 'El sitio web se encuentra inactivo. Por favor contacte al administrador de servidores de sitios web.';
					...
					?>
			            ...
			            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
			                <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
			                    ...
			                    <li class="scroll"><a href="https://tuww.net"><img src='../../imagenes/directorio.png' width='20' title='Directorio de sitios web Guía Clasificada'></a></li>
