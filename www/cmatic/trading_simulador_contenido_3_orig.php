				...
				<div class="box featured">
					...
					<div class="section-title">
						...
						<div class="col-lg-12 mt-4 mt-lg-0" data-aos-delay="100">
							...
							<label hidden><iframe id='marquee_criptos' name='marquee_criptos' width="<?php echo $ancho; ?>" height="10" src="marquee_criptos.php?operar=<?php echo $operar; ?>" frameborder="0" scrolling = "no" allowfullscreen style="border:none;"></iframe></label>
				...
				<div class="box featured">
					...
					<div class="section-title">
						...
						<div class="col-lg-12 mt-4 mt-lg-0" data-aos-delay="100">
							...
							<?php include 'marquee_criptos.php'; ?><br><br>
