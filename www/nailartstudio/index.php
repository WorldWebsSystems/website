	...
	<tr>
		...
		<td width='16%'>
				...
				if ($row33[facebook] <> '') {
					...
					<a href="https://www.instagram.com/<?php echo $row33[facebook]; ?>" target="_blank">
		...
		<td width='16%'>
				...
				if ($row33[linkedin] <> '') {
					...
					<a href="linkedin.com/in/<?php echo $row33[linkedin]; ?>" target="_blank">
					...
					<div class="row">
						...
						<div class="col-sm-7">
							<div class="footer-social">
								<span><i class="fa fa-phone"> <?php echo "+" . $cod_telefono . " " . $celular; ?></i></span>
