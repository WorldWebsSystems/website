<?php
	...
	$resultado33 = mysqli_query($connect, "SELECT count(*) as cantidad FROM red_suscripciones where email = '$email'");
	...
	if ($row33[cantidad] == 0) {
		...
		$concepto = "Suscripcion de Usuario registrada por " . $email . " en tuww.net/" . $carpeta;
