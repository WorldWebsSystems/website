			...
			<section id="about" class="about">
					...
					<div class="row content">
						...
						<div class="col-lg-12">
							...
							<img src='<?php echo $imagen; ?>' class='imgRedonda' width='220' title='Próximamente se habilitarán las funciones para incluir imágenes y editar el contenido'>
							...
							if ($row33[siglas] <> '') {
								...
								echo "<FONT SIZE=5>" . $row33[siglas] . "</FONT></b><br>";
							...
							<font size=2>Fecha/Hora: <b><?php echo $row33[fecha] . " | " . $row33[hora]; ?></b></font>
