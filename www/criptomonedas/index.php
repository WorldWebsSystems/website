					...
					<table width='100%'>
						...
						<tr>
							...
							<td align='center' width='25%'>
								...
								<img src='https://tuww.net/imagenes/<?php echo $imagen_area; ?>' height='50'><br>
							...
							<td align='left' width='75%'>
								...
								<font size=2><b><?php echo $row3311[actividad]; ?></b></font>
						...
						<div class="col-lg-12 pt-4 pt-lg-0">
							...
							<p><h3><b>Datos de contacto:</b></h3></p>
								...
								if ($row33[instagram] <> '') {
									...
									?><img src='https://tuww.net/imagenes/logo_instagram.png' height=18> <a href="https://www.instagram.com/<?php echo $row33[instagram]; ?>" target="_blank"><?php echo $row33[instagram] . "</a><br><br>"; ?><?php
