...
<head>
	...
	<title><?php echo $row33[nombre] . " | " . $row33[descripcion]; ?></title>
...
<body style="background-color:#F0EFEF;">
  ...
  <header id="header" class="fixed-top ">
	...
	?>
      					...
      					<a href="https://tuww.net" class="get-started-btn ml-auto">Ver todos</a>
...
<?php
					...
					echo "<h3><b><a href='https://tuww.net?id=" . $row33[carpeta] . "' target='_blank'>www.tuww.net/" . $row33[carpeta] . "</a></b></b></h3><br>";
