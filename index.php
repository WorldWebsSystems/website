...
<head>
	...
	if ($ver == 'codigofuente') {
		...
		$concepto = "Visita al sitio web cmatic.live";
		...
		<div class="container">
			...
			<div class="row">
							...
							<table>
								...
								<tr>
									...
									<td>
										...
										<a href="directorio_sitiosweb.php"><img src='imagenes/icono_igsitioweb.png' height='32'></a>&nbsp;&nbsp;

									</td>

									<td>

										<a href="directorio_sitiosweb.php"><strong><font size=2>Sitios Web (<?php echo $cantidad_sitiosweb; ?>)</font></strong></a>
							...
							<table>
								...
								<tr>
									...
									<td>
										...
										<a href="ia_demo.php"><img src='imagenes/icono_ia_mini.png' height='32'>&nbsp;&nbsp;</a>

									</td>

									<td>

										<a href="ia_demo.php"><strong><font size=2>Agente IA (DEMO)</font></strong></a>
							...
							<table>
								...
								<tr>
									...
									<td>
										...
										<a href="ia_demo.php"><img src='imagenes/icono_criptomonitor.png' height='32'>&nbsp;&nbsp;</a>

									</td>

									<td>

										<a href="ia_bot.php"><strong><font size=2>IA CriptoMonitor V1</font></strong></a>
				...
				<div class="col-md-12">
					...
					<div align="center">
						...
						<font size=2><strong>NUESTROS SERVICIOS:</strong></font><hr><br>
				...
				<div class="col-md-3">
					...
					<div class="icon-box">
						...
						<img src='../../imagenes/boton_consultar.png' width='120'><br><br>

						<div align="<?php if ($so <> 'movil') {echo "center";}else{echo "left";} ?>">

						<img src='imagenes/icono_ighosting.png' height='75'>

						<?php if ($so <> 'movil') {echo "<br>";} ?><b><font size=4>WebHostings <?php if ($so <> 'movil') {echo "<br>";} ?>Servers</font></a>

						</b><br><br>

						<?php if ($so <> 'movil') {echo "<table><tr><td valign='top' height='".$alto_tabla."'>";} ?>
						...
						<?php if ($so <> 'movil') {echo "</td></tr></table>";} ?>
				...
				<div class="col-md-3">
					...
					<div class="icon-box">
						...
						<a href="sitiosweb.php">

						<img src='../../imagenes/boton_consultar.png' width='120'><br><br>

						<div align="<?php if ($so <> 'movil') {echo "center";}else{echo "left";} ?>">

						<img src='imagenes/icono_igtienda.png' height='75'>
				...
				<div class="col-md-3">
					...
					<div class="icon-box">
						...
						<img src='imagenes/icono_igsoftware.png' height='75'>
				...
				<div class="col-md-3">
					...
					<div class="icon-box">
						...
						<img src='imagenes/icono_igia.png' height='75'>
						...
						<del>&check; Agentes de Análisis de Comportamiento.</del><br><br>

						<del>&check; Motores de Recomendación.</del><br><br>
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					$link_instagram = 'https://www.instagram.com/p/DJyFFVTNo7P/';
